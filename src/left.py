...
pub_left = rospy.Publisher('arm_1/arm_controller/position_command', JointPositions, queue_size=15)
...
def listener():
    ...
    rospy.Subscriber("left", Int32, callback)
