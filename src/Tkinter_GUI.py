...
scale1 = Scale(frame1, label = 'kPThrust', variable = var1, from_ = 0.00, to = 5.00, length=sliderLength, resolution=0.01, command = publishData, orient = HORIZONTAL)
scale1.set(0)
scale1.pack(side=LEFT)
scale2 = Scale(frame1, label = 'kiThrust', variable = var2, from_ = 0, to = 5, length=sliderLength, resolution=0.01, command = publishData, orient = HORIZONTAL)
scale2.set(0)
scale2.pack(side=LEFT)
scale3 = Scale(frame1, label = 'kdThrust', variable = var3, from_ = 0, to = 5, length=sliderLength, resolution=0.01, command = publishData, orient = HORIZONTAL)
scale3.set(0)
scale3.pack(side=LEFT)
scale4 = Scale(frame2, label = 'kpRoll', variable = var4, from_ = 0, to = 5, length=sliderLength, resolution=0.01, command = publishData, orient = HORIZONTAL)
scale4.set(0)
scale4.pack(side = LEFT)
scale5 = Scale(frame2, label = 'kiRoll', variable = var5, from_ = 0, to = 5, length=sliderLength, resolution=0.01, command = publishData, orient = HORIZONTAL)
scale5.set(0)
scale5.pack(side=LEFT)
scale6 = Scale(frame2, label = 'kdRoll', variable = var6, from_ = 0, to = 5, length=sliderLength, resolution=0.01, command = publishData, orient = HORIZONTAL)
scale6.set(0)
scale6.pack(side=LEFT)
scale7 = Scale(frame3, label = 'kpPitch', variable = var7, from_ = 0, to = 5, length=sliderLength, resolution=0.01, command = publishData, orient = HORIZONTAL)
scale7.set(0)
scale7.pack(side=LEFT)
scale8 = Scale(frame3, label = 'kiPitch', variable = var8, from_ = 0, to = 5, length=sliderLength, resolution=0.01, command = publishData, orient = HORIZONTAL)
scale8.set(0)
scale8.pack(side=LEFT)
scale9 = Scale(frame3, label = 'kdPitch', variable = var9, from_ = 0, to = 5, length=sliderLength, resolution=0.01, command = publishData, orient = HORIZONTAL)
scale9.set(0)
scale9.pack(side=LEFT)
scale10 = Scale(frame4, label = 'kpYaw', variable = var10, from_ = 0, to = 5, length=sliderLength, resolution=0.01, command = publishData, orient = HORIZONTAL)
scale10.set(0)
scale10.pack(side = LEFT)
scale11 = Scale(frame4, label = 'kiYaw', variable = var11, from_ = 0, to = 5, length=sliderLength, resolution=0.01, command = publishData, orient = HORIZONTAL)
scale11.set(0)
scale11.pack(side=LEFT)
scale12 = Scale(frame4, label = 'kdYaw', variable = var12, from_ = 0, to = 5, length=sliderLength, resolution=0.01, command = publishData, orient = HORIZONTAL)
scale12.set(0)
